...
Module OrdProperties_fun (E:OrderedType) (M:Sfun E).
  Module Import ME := OrderedTypeFacts E.
  Module Import O := KeyOrderedType E.
...
End OrdProperties_fun.

Module OrdProperties (M:S).
  Include (OrdProperties_fun M.E M).
End OrdProperties.
