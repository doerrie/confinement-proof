...
Module Type WSfun (E : DecidableType).
  ...
  Section Types.
    ...
    (** [map2 f m m'] allocates a new map whose bindings belong to the ones
...
(** ** Maps with ordering on both keys and datas. *)
Module Type Sord_fun (E:OrderedType) (MapS: Sfun E) (Data:OrderedType).
...
(** ** Maps with ordering both on keys and datas, self-contained signature *)

Module Type Sord.

  Declare Module Data : OrderedType.
  Declare Module MapS : S.
  Include (Sord_fun MapS.E MapS Data).
